...
double  angle
   ...
   {
     double small1, undefined, magv1, magv2, temp;
     small1     = 0.00000001;
     undefined = 999999.1;
...
*
*  revisions
*    vallado     - fix small1                                     24 sep 2002
*
*  inputs          description                    range / units
...
void rv2coe
     ...
     {
       double undefined, small1, hbar[3], nbar[3], magr, magv, magn, ebar[3], sme,
     ...
     if ( magh > small1 )
       {
         ...
         if ( ecc < small1 )
           {
             // ----------------  circular equatorial ---------------
             if  ((incl<small1) | (fabs(incl-pi)<small1))
         ...
         if  (( ecc>small1 ) && (strcmp(typeorbit,"ee") == 0))
           {
             temp= ebar[0]/ecc;
             if ( fabs(temp) > 1.0  )
                 temp= sgn(temp);
         ...
         if  (( magr>small1 ) && ( strcmp(typeorbit,"ce") == 0 ))
           {
             temp= r[0]/magr;
             if ( fabs(temp) > 1.0  )
                 temp= sgn(temp);
