...
// DialogProject.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDialogProjectApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CDialogProjectApp

CDialogProjectApp::CDialogProjectApp()
{
...
// Единственный объект CDialogProjectApp

CDialogProjectApp theApp;


// инициализация CDialogProjectApp

BOOL CDialogProjectApp::InitInstance()
{
